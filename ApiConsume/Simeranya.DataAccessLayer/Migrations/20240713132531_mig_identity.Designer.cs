...
namespace Simeranya.DataAccessLayer.Migrations
{
    ...
    [Migration("20240713132531_mig_identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Simeranya.EntityLayer.Concreate.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Simeranya.EntityLayer.Concreate.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Simeranya.EntityLayer.Concreate.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Simeranya.EntityLayer.Concreate.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Simeranya.EntityLayer.Concreate.AppUser", b =>
                {
                    b.HasOne("Simeranya.EntityLayer.Concreate.WorkLocation", "WorkLocation")
                        .WithMany()
